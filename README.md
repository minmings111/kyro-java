...
특히 동적 타입과 관례 중심의 접근 제어는 초기 개발 속도를 높여주지만, 프로젝트 규모가 커질수록 어떤 객체가 어떤 책임을 가져야 하는지, 어떤 값이 어느 계층까지 전달되어야 하는지, 모듈 간 계약이 어디서 강제되는지 파악하기 어려워질 수 있다고 느꼈습니다. 상속, 인터페이스, 접근 제어자, 패키지 구조를 통해 책임을 더 명확하게 표현할 수 있는 Java/Spring Boot로 옮기면서 구조를 다시 잡기로 했습니다.
